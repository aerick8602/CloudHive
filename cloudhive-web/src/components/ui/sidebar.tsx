...
function SidebarContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-6 pt-1 overflow-auto group-data-[collapsible=icon]:overflow-hidden",
        className
      )}
      {...props}
    />
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn("group/menu-item relative pl-1", className)}
      {...props}
    />
  );
}
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      className={cn("group/menu-sub-item relative mr-5", className)}
      {...props}
    />
  );
}
