...
export function UploadToast({
  ...
  return (
    <motion.div
      ...
      className="relative flex w-full max-w-sm p-4 rounded-xl border border-border bg-background shadow-xl mx-auto sm:mx-0"
    >
      {/* Close Button */}
      <motion.button
        onClick={onClose}
      ...
      <div className="flex gap-3 items-start w-full">
        ...
        {/* Content */}
        <div className="flex-1 flex flex-col gap-1.5 pr-2">
          <span className="text-sm font-semibold text-foreground truncate max-w-[calc(100%-40px)]">
            {" "}
            {/* Adjusted max-width for text truncation */}
            {isComplete
              ? "Upload complete"
              : `Uploading ${totalFiles} ${fileText}`}
          </span>
          ...
          <div className="flex justify-between items-center">
            <span className="text-xs text-muted-foreground truncate max-w-[calc(100%-50px)]">
              {" "}
              {/* Adjusted max-width for text truncation */}
              {isComplete
                ? `Successfully uploaded ${totalFiles} ${fileText}`
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 items-start w-full">
        ...
        <div className="flex-1 flex flex-col gap-1.5 pr-2">
          <span className="text-sm font-semibold text-destructive truncate max-w-[calc(100%-40px)]">
            {" "}
            {/* Adjusted max-width for text truncation */}
            Upload failed
          </span>
